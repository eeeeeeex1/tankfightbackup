System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Input, input, RigidBody2D, instantiate, AudioSource, Vec2, PlayerController0, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _class3, _crd, ccclass, property, firedirection0;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("firedirection0", firedirection0 = (_dec = ccclass('firedirection0'), _dec2 = property(AudioSource), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec(_class = (_class2 = (_class3 = class firedirection0 extends Component {
        constructor() {
          super(...arguments);
        ...
        update() {
          var playercontroller0 = this.node.parent.getComponent(_crd && PlayerController0 === void 0 ? (_reportPossibleCrUseOfPlayerController({
            error: Error()
        ...
        fireBullet() {
          ...
          this.speed = new Vec2(this.currentiondirection.x * this.shootPower, this.currentiondirection.y * this.shootPower); //console.log( 'this.speed ',this.speed );
...
//# sourceMappingURL=c1785c9a459ad6794f76476877efca01022166fd.js.map