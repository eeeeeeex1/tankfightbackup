      ...
      _export("time02", time02 = (_dec = ccclass('time02'), _dec2 = property(AudioSource), _dec(_class2 = (_class3 = class time02 extends Component {
        ...
        update(deltaTime) {
          ...
          if (!find("Canvas/background/tank/enemytank") && find("Canvas/background/tank/playertank")) {
            ...
            if (RegSet[i].d1time == 0) RegSet[i].d1time = Number((RegSet[i].d1time1 + RegSet[i].d1time2).toFixed(2));else {
              if (RegSet[i].d1time > RegSet[i].d1time1 + RegSet[i].d1time2) RegSet[i].d1time = Number((RegSet[i].d1time1 + RegSet[i].d1time2).toFixed(2));
            }
            RegSet[i].save = 2;
...
//# sourceMappingURL=d40da52c2b914ec7b7f62801c77acc9c7e19cc65.js.map