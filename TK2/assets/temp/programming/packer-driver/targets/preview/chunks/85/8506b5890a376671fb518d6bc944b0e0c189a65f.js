    ...
    execute: function () {
      ...
      _export("background", background = (_dec = ccclass('background'), _dec(_class = class background extends Component {
        start() {
          ...
          var ctx = this.node.getComponent(Graphics); // 创建一个 cc.Color 对象，并设置为蓝色

          var blueColor = new Color().fromHEX('#F5ECEB'); // 设置 Graphics 组件的填充颜色
...
//# sourceMappingURL=8506b5890a376671fb518d6bc944b0e0c189a65f.js.map