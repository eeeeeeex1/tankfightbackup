  ...
  return {
    ...
    execute: function () {
      ...
      _export("TankCheatController", TankCheatController = (_dec = ccclass('TankCheatController'), _dec2 = property(Node), _dec(_class = (_class2 = class TankCheatController extends Component {
        ...
        onKeyDown(event) {
          // 获取按下的键名
          let key = event.keyCode; // 检查是否是字母键
          ...
          if (key >= macro.KEY.a && key <= macro.KEY.z || key >= macro.KEY.A && key <= macro.KEY.Z) {
            ...
            if (this.cheatCode === "zhaoyibo") {
              ...
              const playercontroller0 = this.tankNode.getComponent(_crd && PlayerController0 === void 0 ? (_reportPossibleCrUseOfPlayerController({
                error: Error()
...
//# sourceMappingURL=ad6c0853b28312be8d8bd4e2ece8faa9c7a68e01.js.map