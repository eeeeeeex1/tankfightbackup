System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, SpriteFrame, RigidBody2D, Vec3, Collider2D, Contact2DType, Vec2, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, Direction, Directions, enemytank_001;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("enemytank_001", enemytank_001 = (_dec = ccclass('enemytank_001'), _dec2 = property(RigidBody2D), _dec3 = property(SpriteFrame), _dec(_class = (_class2 = class enemytank_001 extends Component {
        constructor(...args) {
          super(...args);
        ...
        changeDirection() {
          ...
          if ((this.aitankspeed.x !== 0 || this.aitankspeed.y !== 0) && this.sign === 0) {
            let newVelocity = this.aitankspeed.clone().multiplyScalar(this.speed); //给坦克赋值速度
...
//# sourceMappingURL=9d0a93837a709fc36ca97b9a11ceb65d0326ecba.js.map