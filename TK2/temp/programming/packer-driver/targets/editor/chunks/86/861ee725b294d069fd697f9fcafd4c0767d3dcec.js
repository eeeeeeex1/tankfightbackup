System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Button, director, AudioSource, PassInf, user, _dec, _dec2, _class2, _class3, _descriptor, _crd, ccclass, property, adventure;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "c0cc50iT6JBZqHaVEGRsStv", "adventure", undefined);
      ...
      _export("adventure", adventure = (_dec = ccclass('adventure'), _dec2 = property(AudioSource), _dec(_class2 = (_class3 = class adventure extends Component {
        constructor(...args) {
          super(...args);
        ...
        loadSinglePlayerScene() {
          ...
          if (this.CurrentUser.save != 0) director.loadScene('single'); //有存档则进入继续游戏界面
          else director.loadScene('single1'); //没有则选择游戏模式
        }
...
//# sourceMappingURL=861ee725b294d069fd697f9fcafd4c0767d3dcec.js.map