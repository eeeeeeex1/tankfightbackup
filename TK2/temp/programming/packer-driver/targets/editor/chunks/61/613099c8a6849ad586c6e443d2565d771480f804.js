      ...
      _export("objectmovefast", objectmovefast = (_dec = ccclass('objectmovefast'), _dec(_class = class objectmovefast extends Component {
        ...
        onBeginContact(selfCollider, otherCollider) {
          if (otherCollider.node.name === "tank0" || otherCollider.node.name === "tank1") {
            ...
            const playercontroller1 = otherCollider.getComponent(_crd && PlayerController1 === void 0 ? (_reportPossibleCrUseOfPlayerController2({
              error: Error()
...
//# sourceMappingURL=613099c8a6849ad586c6e443d2565d771480f804.js.map