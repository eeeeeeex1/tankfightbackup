System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfenemyfire(extras) {
    _reporterNs.report("enemyfire", "./enemytank/enemyfire", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "da263CNBTRKfL9xOuXqnrqh", "tietu", undefined);
      ...
      _export("sprite", sprite = (_dec = ccclass('sprite.node'), _dec(_class = class sprite extends Component {
        ...
        changeDirection() {
          const x = this.node.parent.getChildByName('firedirection').getComponent(_crd && enemyfire === void 0 ? (_reportPossibleCrUseOfenemyfire({
            error: Error()
          }), enemyfire) : enemyfire).speed.x;
          const y = this.node.parent.getChildByName('firedirection').getComponent(_crd && enemyfire === void 0 ? (_reportPossibleCrUseOfenemyfire({
            error: Error()
...
//# sourceMappingURL=6c7757b16e9342b9c34ee750af3a6d6ad75ce6ef.js.map