      ...
      _export("continueGame", continueGame = (_dec = ccclass('continueGame'), _dec2 = property(AudioSource), _dec(_class2 = (_class3 = class continueGame extends Component {
        ...
        Continue_Game() {
          ...
          if (this.currentUser.difficulty == 1) {
            if (this.currentUser.save == 1) director.loadScene('alonemap2');
            if (this.currentUser.save == 2) director.loadScene('alonemap3');
          } else if (this.currentUser.difficulty == 2) {
            if (this.currentUser.save == 1) director.loadScene('alonemap2-difficult');
            if (this.currentUser.save == 2) director.loadScene('alonemap3-difficult');
          }
        } //根据用户所选难度读档
...
//# sourceMappingURL=de99df5388e3001faa0b2435259bc53d1f15e678.js.map