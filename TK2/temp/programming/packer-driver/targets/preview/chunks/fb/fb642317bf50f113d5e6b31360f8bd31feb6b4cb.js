System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, find, director, AudioSource, PassInf, user, _dec, _dec2, _class2, _class3, _descriptor, _crd, ccclass, property, time01;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("time01", time01 = (_dec = ccclass('time01'), _dec2 = property(AudioSource), _dec(_class2 = (_class3 = class time01 extends Component {
        constructor() {
          super(...arguments);
          ...
          if (!find("Canvas/background/tank/enemytank") && find("Canvas/background/tank/playertank")) //检测是否击杀所有敌人并存活
            {
              ...
              var time = this.endTime - this.startTime; //计算通关时间
              ...
              RegSet[i].d1time3 = time / 1000;
              if (RegSet[i].d1time == 0) RegSet[i].d1time = Number((RegSet[i].d1time1 + RegSet[i].d1time2 + RegSet[i].d1time3).toFixed(2));else {
                if (RegSet[i].d1time > RegSet[i].d1time1 + RegSet[i].d1time2 + RegSet[i].d1time3) RegSet[i].d1time = Number((RegSet[i].d1time1 + RegSet[i].d1time2 + RegSet[i].d1time3).toFixed(2));
              }
              RegSet[i].save = 0; //存储通关记录
...
//# sourceMappingURL=fb642317bf50f113d5e6b31360f8bd31feb6b4cb.js.map