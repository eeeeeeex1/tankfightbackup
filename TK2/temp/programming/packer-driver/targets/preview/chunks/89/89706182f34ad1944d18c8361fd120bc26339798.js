System.register(["__unresolved_0", "cc"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Input, input, Node, RigidBody2D, Vec3, instantiate, AudioSource, CameraComponent, Vec2, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _class3, _crd, ccclass, property, playerfire;
    ...
    execute: function () {
      ...
      _export("playerfire", playerfire = (_dec = ccclass('playerfire'), _dec2 = property(AudioSource), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Node), _dec(_class = (_class2 = (_class3 = class playerfire extends Component {
        constructor() {
          ...
          _initializerDefineProperty(this, "Carmera", _descriptor7, this);
        ...
        fireBullet() {
          var bullet = instantiate(this.bulletPrefab); //音效模块
          ...
          var worldPosition = this.node.getWorldPosition();
          var Camera0 = this.Carmera.getComponent(CameraComponent);
          var screenPosition = new Vec3();
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "Carmera", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=89706182f34ad1944d18c8361fd120bc26339798.js.map