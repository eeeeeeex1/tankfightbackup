    ...
    execute: function () {
      ...
      _export("fort", fort = (_dec = ccclass('fort'), _dec2 = property(Node), _dec(_class = (_class2 = class fort extends Component {
        ...
        changeDirection() {
          ...
          var Camera0 = this.Carmera.getComponent(Camera);
          var screenPosition = new Vec3();
          Camera0.worldToScreen(worldPosition, screenPosition);
          var x = this.Mouseposition.x - screenPosition.x;
          var y = this.Mouseposition.y - screenPosition.y; // 计算新的旋转角度

          var angle = Math.atan2(Math.abs(y), Math.abs(x)) * (180 / Math.PI); // 应用旋转角度到sprite附属节点
...
//# sourceMappingURL=5a7f361d44bdee39f48589ac94802aa554ad1cde.js.map