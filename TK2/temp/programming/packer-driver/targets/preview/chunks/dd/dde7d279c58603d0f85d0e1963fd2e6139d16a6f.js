System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, RigidBody2D, instantiate, Vec2, enemytank_001, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _crd, ccclass, property, enemyfire;
    ...
    execute: function () {
      ...
      _export("enemyfire", enemyfire = (_dec = ccclass('enemyfire'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec(_class = (_class2 = (_class3 = class enemyfire extends Component {
        ...
        fireBullet() {
          ...
          var tank = this.node.parent.getComponent(_crd && enemytank_001 === void 0 ? (_reportPossibleCrUseOfenemytank_({
            error: Error()
          }), enemytank_001) : enemytank_001);
          var rgd = bullet.getComponent(RigidBody2D); //如果tank没有捕捉到player 肯定有一个方向为0
...
//# sourceMappingURL=dde7d279c58603d0f85d0e1963fd2e6139d16a6f.js.map