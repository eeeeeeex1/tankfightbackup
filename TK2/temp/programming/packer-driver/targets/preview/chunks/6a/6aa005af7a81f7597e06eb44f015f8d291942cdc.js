    ...
    execute: function () {
      ...
      _export("tankdestroy", tankdestroy = (_dec = ccclass('tankdestroy'), _dec(_class = class tankdestroy extends Component {
        update(deltaTime) {
          ...
          var playercontroller1 = this.node.parent.getComponent(_crd && PlayerController1 === void 0 ? (_reportPossibleCrUseOfPlayerController2({
            error: Error()
...
//# sourceMappingURL=6aa005af7a81f7597e06eb44f015f8d291942cdc.js.map